    ...
    <div id="search">
        ...
        <div class="result" v-if="searchRes!=null&&searchShow">
            <div class="result-group" v-if="searchRes.song!=null">
                <div class="group">
                    <img src="./../assets/icon-music.png" class="group-img">
                    <p class="group-p">单曲</p>
                </div>

                <div class="result-it" v-for="(item, index) in searchRes.song.itemlist">
            ...
            <div class="result-group" v-if="searchRes.mv!=null">
                ...
                <div class="mv-item" @click="openmv(item.vid)"
